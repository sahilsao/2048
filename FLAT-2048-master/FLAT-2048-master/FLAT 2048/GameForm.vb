Public Class GameForm
    ...
    Private Sub GameForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ReadData()
        Me.Text = " 2048 - Current Score: " & OldScore
        Label3.Text = OldScore
        isClean = True
        isDisplay = True
        isExit = True
        isExitConfirm = False
    ...
    Private Sub RollScoreTimer_Tick(sender As Object, e As EventArgs) Handles RollScoreTimer.Tick
        If isDisplay Then
            Me.Text = " 2048 - High Score: " & HighScore
            Label4.Text = HighScore
        Else
            Me.Text = " 2048 - Current Score: " & NewScore
            Label3.Text = OldScore
        End If
    ...
    Private Sub MoveGrid()
        ...
        Next
        If isMove Then
            If NewScore > HighScore Then HighScore = NewScore
